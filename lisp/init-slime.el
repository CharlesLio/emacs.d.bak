...
(defun sanityinc/slime-repl-insert-banner ()
  (when (zerop (buffer-size))
    (let ((slime-welcome (format ";; SLIME %s\n" slime-version)))
      (insert slime-welcome))))

(after-load 'slime
  (setq slime-net-coding-system 'utf-8-unix
        slime-repl-banner-function 'sanityinc/slime-repl-insert-banner)
